...
\resumeHeadingListStart{}
  ...
  \resumeItemListStart{}
    \resumeItem{Developed cloud infrastructure for various projects (from 1 to 10+ services per environment) using AWS, Terraform, GitLab CI, Ruby/Python/Node.js, etc.}
    \resumeItem{Implemented solution for running dynamic environments per feature branch using Uffizzi, GitLab CI, AWS, Traefik.}
    ...
    \resumeItem{Have experience as a TeamLead on the Python Django project.}
  \resumeItemListEnd{}
