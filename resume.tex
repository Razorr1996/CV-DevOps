...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Mobile: \hrefUline{tel:+79819547080}{+7 981 954-70-80} / \hrefUline{tel:+38269532916}{+382 69 532916} \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\resumeHeadingListStart{}
  ...
  \resumeItemListStart{}
    \resumeItem{Developed cloud infrastructure for various projects (from 1 to 10+ services per environment): AWS, Terraform, GitLab CI, Ruby/Python/Node.js, etc.}
    \resumeItem{Implemented solution for running dynamic environments per feature branch: Uffizzi, GitLab CI, AWS, Traefik.}
    \resumeItem{Managed work for infrastructure across projects and the company.}
