...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Artem Basalaev \vspace{2pt}} & % row = 1, col = 1
  Location: Budva, Montenegro \\ % row = 1, col = 2
  %\href{https://jane-doe.com}{\uline{jane-doe.com}} $|$ % row = 2, col = 1
  \href{https://linkedin.com/in/artem-basalaev}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://gitlab.com/Razorr1996}{\uline{GitLab}} $|$ % row = 2, col = 1
  \href{https://github.com/Razorr1996}{\uline{GitHub}} $|$ % row = 2, col = 1
  %\href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
  Email: \href{mailto:basa62.1996@gmail.com}{\uline{basa62.1996@gmail.com}} $|$ % row = 2, col = 2
  Mobile: \href{tel:+79819547080}{\uline{+79819547080}} \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\small{
\todo{sum}
  I am a highly skilled DevOps engineer with over \textbf{6 years of experience} in \textbf{HTML, CSS, JavaScript, and PHP}. I have knowledge of popular frameworks such as \textbf{React, Angular, and Vue.js} and experience with REST APIs and MVC frameworks.
}
%--------------------------------------------
...
\resumeHeadingListStart{}
  ...
  {\href{https://www.linkedin.com/company/dualbootpartners/}{Dualboot Partners}}{Remote -- Saint Petersburg, Russia}
  \todo{w3}
    % \resumeItemListStart{}
  ...
  {\href{https://www.linkedin.com/company/solanteq/}{Solanteq}}{Saint Petersburg, Russia}
  \todo{w2}
    % \resumeItemListStart{}
  ...
  \resumeQuadHeading{Developer/System Administrator}{May 2017 -- Dec 2018}{}{Saint Petersburg, Russia}
  \todo{w1}
    % \resumeItemListStart{}
