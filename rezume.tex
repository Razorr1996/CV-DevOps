...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Mobile: +79819547080 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\small{
  TODO I am a highly skilled web developer with over \textbf{3 years of experience} in \textbf{HTML, CSS, JavaScript, and PHP}. I have knowledge of popular frameworks such as \textbf{React, Angular, and Vue.js} and experience with REST APIs and MVC frameworks.
}
%--------------------------------------------
...
\section{Education}
  \resumeHeadingListStart{}
    ...
    {Master of Science in Computer Science}{Sep 2018 -- Aug 2020}
  \resumeHeadingListEnd{}
%---------------------------------------------
