...
\small{
I am a highly skilled DevOps engineer and \textbf{Certified Kubernetes Administrator} with over \textbf{9 years of experience} in \textbf{Cloud Providers, Container Orchestration, CI/CD, Linux, Web Servers, and Networks}. Also I'm an OSS contributor.

Languages: \textbf{Russian} (Native), \textbf{English} (Upper Intermediate), \textbf{Serbian} (Intermediate).
}
%--------------------------------------------
...
\section{Experience}
\resumeHeadingListStart{}
\resumeQuadHeading{Site Reliability Engineer}{Mar 2025 -- Present}
{\hrefUline{https://www.linkedin.com/company/yandex/}{Yandex}}{Belgrade, Serbia}

  \resumeQuadHeading{Senior DevOps Engineer}{Apr 2024 -- Mar 2025}
  {\hrefUline{https://www.linkedin.com/company/naviteq-solutions/}{Naviteq} / \hrefUline{https://www.linkedin.com/company/loris-ai/}{Loris.ai}}{Remote}
%    \resumeItemListStart{}
%      \resumeItem{Simplified the deployment of new locations by unification IaC using Terragrunt, Terraform, and ArgoCD "app-of-apps" pattern.}
%    \resumeItemListEnd{}

  \resumeQuadHeading{DevOps Lead}{Aug 2021 -- Apr 2024}
  ...
  \resumeItemListStart{}
    ...
    \resumeItem{Had experience as a Team Lead on the Python Django project.}
  \resumeItemListEnd{}
